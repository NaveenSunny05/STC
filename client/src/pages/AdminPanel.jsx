          ...
          <div className="flex border-b border-gray-800 overflow-x-auto scrollbar-hide">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-4 font-medium whitespace-nowrap ${activeTab === tab.id ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-400 hover:text-white'
                  }`}
              >
                ...
                <div className="bg-gray-800 border border-gray-700 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center gap-2 bg-blue-600 hover:bg-blue-700 px-4 py-3 rounded-lg transition"
                    >
